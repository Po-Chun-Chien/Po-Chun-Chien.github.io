...
paperurl: ""
citation: "S. Rai et al., Logic Synthesis Meets Machine Learning: Trading Exactness for Generalization, <i>In Proceedings of the the Design, Automation and Test in Europe Conference (DATE)</i>, 2021."
---
Abstract:  
...
[comment]: # (Recommended citation: S. Rai et al., Logic Synthesis Meets Machine Learning: Trading Exactness for Generalization, <i>In Proceedings of the the Design, Automation and Test in Europe Conference (DATE)</i>, 2021.)